/**
 * It is a Processing library for the Kinect for Windows SDK 1.5.
 *
 * ##copyright##
 *
...
public class PKinect implements PConstants, KinectConstants, Runnable {
	static {
		int arch = Integer.parseInt(System.getProperty("sun.arch.data.model"));
		if (arch == 64) {
			System.loadLibrary("PKinect64");
		} else {
			System.loadLibrary("PKinect32");
		}
	}

	public final static String VERSION = "version 1.1.0";
	...
	private void welcome() {
		System.out.println("PKinect 1.1.0 by Bryan Chung");
	}
